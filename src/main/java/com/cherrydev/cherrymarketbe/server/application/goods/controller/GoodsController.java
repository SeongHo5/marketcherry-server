...
public class GoodsController {
  ...
  @Cacheable(
      ...
      key = "#sort",
      condition =
          "#sort != null && #goodsName == null && #categoryId == null && #makerId == null && #isOnDiscount == null")
  public ResponseEntity<Page<GoodsInfo>> fetchGoodsByConditions(
    ...
    GoodsSearchConditions conditions =
        new GoodsSearchConditions(goodsName, categoryId, makerId, isOnDiscount, sort);
