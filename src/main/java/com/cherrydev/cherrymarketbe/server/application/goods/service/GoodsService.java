...
public class GoodsService {
  ...
  public Page<GoodsInfo> fetchGoodsByConditions(
      Pageable pageable, GoodsSearchConditions conditions) {
    List<GoodsInfo> goodsList =
        customGoodsRepository.findByConditions(pageable, conditions).stream()
            .map(GoodsInfo::of)
            .toList();
