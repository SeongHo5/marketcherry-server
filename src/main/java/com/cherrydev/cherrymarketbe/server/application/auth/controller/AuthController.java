...
public class AuthController {
  ...
  public ResponseEntity<Void> signOut(@PathVariable("access_token") final String accessToken) {
  ...
  public ResponseEntity<JwtReissueResponse> reissue(@RequestBody final RequestJwt requestJwt) {
    JwtReissueResponse response = authService.reissue(requestJwt);
    return ResponseEntity.ok().header(AUTHORIZATION, response.accessToken()).body(response);
  }
  ...
  public ResponseEntity<Void> sendEmail(@RequestParam @Email final String email) {
  ...
  public ResponseEntity<Void> verifyEmail(
      @RequestParam final String email, @RequestParam final String verificationCode) {
  ...
  public ResponseEntity<Void> sendPasswordResetEmail(@RequestParam @Email final String email) {
