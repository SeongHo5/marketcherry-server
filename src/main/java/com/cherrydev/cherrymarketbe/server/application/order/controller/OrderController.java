...
public class OrderController {
  ...
  public ResponseEntity<Page<OrderInfoResponse>> fetchAllMyOrders(
      @AuthenticationPrincipal AccountDetails accountDetails, Pageable pageable) {
    return ResponseEntity.ok(orderService.fetchAllMyOrders(accountDetails, pageable));
  }
  ...
  public ResponseEntity<OrderSummary> fetchOrderDetails(
    ...
    return ResponseEntity.ok(orderService.fetchOrderDetails(orderCode));
  }
  ...
  public ResponseEntity<OrderCreateResponse> createOrder(
    ...
    return ResponseEntity.status(CREATED).body(orderService.createOrder(accountDetails, request));
  }
