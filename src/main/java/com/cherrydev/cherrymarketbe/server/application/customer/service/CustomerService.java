...
public class CustomerService {
  ...
  @Transactional
  public void registerCoupon(final AccountDetails accountDetails, final String couponCode) {
  ...
  public List<CouponInfo> getCouponList(final AccountDetails accountDetails) {
    Account account = accountDetails.getAccount();
    return customerCouponRepository.findAllByAccount(account).stream()
