...
public class AccountService {
  ...
  public void createAccountByOAuth(final OAuthAccountInfo oAuthAccountInfo, final String provider) {
    ...
    Account account =
        Account.from(oAuthAccountInfo, encodedPassword, RegisterType.valueOf(provider));
  ...
  public AccountInfo modifyAccountInfo(
      final AccountDetails accountDetails, final RequestModifyAccountInfo requestDto) {
    Account account = accountDetails.getAccount();
