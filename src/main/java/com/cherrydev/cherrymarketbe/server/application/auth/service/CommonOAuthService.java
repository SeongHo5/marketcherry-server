...
public class CommonOAuthService {
  ...
  public SignInResponse processSignIn(final OAuthAccountInfo accountInfo, final String provider) {
  ...
  private SignInResponse createSignInResponse(
      final JwtResponse jwtResponse, final String userName) {
  ...
  private void checkAndProcessOAuthRegistration(
      final OAuthAccountInfo accountInfo, final String provider) {
    String email = accountInfo.getEmail();
