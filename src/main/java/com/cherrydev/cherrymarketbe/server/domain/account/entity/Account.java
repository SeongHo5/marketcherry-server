...
@SQLDelete(
    sql =
        "UPDATE ACNT SET ACNT_STTUS = 'DELETED', DELETED_DE = CURRENT_TIMESTAMP WHERE ACNT_ID = ?")
public class Account extends BaseEntity {
  ...
  public static Account from(
      RequestSignUp request, String encodedPassword, RegisterType registerType) {
  ...
  /** 소셜 로그인 시 계정 생성 */
  public static Account from(
      OAuthAccountInfo oAuthAccountInfo, String encodedPassword, RegisterType registerType) {
    return Account.builder()
