...
public class AdminFactory {
  ...
  public static ModifyUserRole createModifyUserRoleRequestDtoA() {
    return ModifyUserRole.builder().email("jeongnamgim@example.org").newRole("ROLE_SELLER").build();
  }
  ...
  public static ModifyUserStatus createModifyUserStatusByAdminDtoB() {
    return ModifyUserStatus.builder().email("kgim@example.net").newStatus("RESTRICTED").build();
  }
