...
public class TestHelper {
   ...
   * @return DynamicTest
   */
  public DynamicTest testApiEndpoint(
      String testName, RequestBuilder requestBuilder, ResultMatcher expectedStatus) {
    String[] split = testName.split("-");
    String identifierName = split[0];
    ...
    return DynamicTest.dynamicTest(
        ...
        () ->
            mockMvc
                ...
                .andDo(document(documentName, resourceDetails().tag(identifierName))));
  }
