...
class FileServiceTest {
  ...
  @Mock private AmazonS3Client objectStorageClient;
  ...
  void shouldUploadSingleFile() throws IOException {
    ...
    when(objectStorageClient.getUrl(eq(BUCKET_NAME), anyString()))
        .thenReturn(new URL("http://example.com/test.jpg")); // Sample URL
